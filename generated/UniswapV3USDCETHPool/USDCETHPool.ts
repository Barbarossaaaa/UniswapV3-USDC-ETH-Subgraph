...
export class USDCETHPool__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__mintResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__observationsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class USDCETHPool__observeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class USDCETHPool__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class USDCETHPool__protocolFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class USDCETHPool__snapshotCumulativesInsideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class USDCETHPool__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class USDCETHPool__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class USDCETHPool extends ethereum.SmartContract {
  static bind(address: Address): USDCETHPool {
    return new USDCETHPool("USDCETHPool", address);
  }
  ...
  burn(
    ...
    return new USDCETHPool__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_burn(
    ...
    tickUpper: i32,
    amount: BigInt
  ): ethereum.CallResult<USDCETHPool__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new USDCETHPool__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collect(
    ...
    return new USDCETHPool__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<USDCETHPool__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__collectResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): USDCETHPool__collectProtocolResult {
    let result = super.call(
      "collectProtocol",
    ...
    return new USDCETHPool__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<USDCETHPool__collectProtocolResult> {
    let result = super.tryCall(
      "collectProtocol",
      "collectProtocol(address,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  mint(
    ...
    return new USDCETHPool__mintResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_mint(
    ...
    amount: BigInt,
    data: Bytes
  ): ethereum.CallResult<USDCETHPool__mintResult> {
    let result = super.tryCall(
      "mint",
      "mint(address,int24,int24,uint128,bytes):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__mintResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  observations(param0: BigInt): USDCETHPool__observationsResult {
    let result = super.call(
      "observations",
    ...
    return new USDCETHPool__observationsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_observations(
    param0: BigInt
  ): ethereum.CallResult<USDCETHPool__observationsResult> {
    let result = super.tryCall(
      "observations",
      "observations(uint256):(uint32,int56,uint160,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__observationsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  observe(secondsAgos: Array<BigInt>): USDCETHPool__observeResult {
    let result = super.call(
      "observe",
    ...
    return new USDCETHPool__observeResult(
  ...
  try_observe(
  ...
  ): ethereum.CallResult<USDCETHPool__observeResult> {
    let result = super.tryCall(
      "observe",
      "observe(uint32[]):(int56[],uint160[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__observeResult(
  ...
  positions(param0: Bytes): USDCETHPool__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new USDCETHPool__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(
    param0: Bytes
  ): ethereum.CallResult<USDCETHPool__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__positionsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  protocolFees(): USDCETHPool__protocolFeesResult {
    let result = super.call(
      "protocolFees",
    ...
    return new USDCETHPool__protocolFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_protocolFees(): ethereum.CallResult<USDCETHPool__protocolFeesResult> {
    let result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__protocolFeesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  slot0(): USDCETHPool__slot0Result {
    let result = super.call(
      "slot0",
    ...
    return new USDCETHPool__slot0Result(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_slot0(): ethereum.CallResult<USDCETHPool__slot0Result> {
    let result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
  ...
  snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): USDCETHPool__snapshotCumulativesInsideResult {
    let result = super.call(
      "snapshotCumulativesInside",
    ...
    return new USDCETHPool__snapshotCumulativesInsideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): ethereum.CallResult<USDCETHPool__snapshotCumulativesInsideResult> {
    let result = super.tryCall(
      "snapshotCumulativesInside",
      "snapshotCumulativesInside(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(tickLower), ethereum.Value.fromI32(tickUpper)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__snapshotCumulativesInsideResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  swap(
    ...
    return new USDCETHPool__swapResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_swap(
    ...
    sqrtPriceLimitX96: BigInt,
    data: Bytes
  ): ethereum.CallResult<USDCETHPool__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new USDCETHPool__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  ticks(param0: i32): USDCETHPool__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new USDCETHPool__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(param0: i32): ethereum.CallResult<USDCETHPool__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(param0)]
