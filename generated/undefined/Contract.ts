...
export class Contract__collectResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__collectProtocolResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__observeResult {
  value0: Array<BigInt>;
  value1: Array<BigInt>;
...
export class Contract__protocolFeesResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__slot0Result {
  value0: BigInt;
  value1: i32;
  value2: i32;
  value3: i32;
...
export class Contract__snapshotCumulativesInsideResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class Contract__swapResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract__ticksResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  burn(tickLower: i32, tickUpper: i32, amount: BigInt): Contract__burnResult {
  ...
  collect(
    ...
    return new Contract__collectResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collect(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<Contract__collectResult> {
    let result = super.tryCall(
      "collect",
      "collect(address,int24,int24,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__collectResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): Contract__collectProtocolResult {
    let result = super.call(
      "collectProtocol",
    ...
    return new Contract__collectProtocolResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_collectProtocol(
    ...
    amount0Requested: BigInt,
    amount1Requested: BigInt
  ): ethereum.CallResult<Contract__collectProtocolResult> {
    let result = super.tryCall(
      "collectProtocol",
      "collectProtocol(address,uint128,uint128):(uint128,uint128)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__collectProtocolResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  mint(
    ...
    return new Contract__mintResult(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_mint(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__mintResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  observe(secondsAgos: Array<BigInt>): Contract__observeResult {
    let result = super.call(
      "observe",
    ...
    return new Contract__observeResult(
  ...
  ): ethereum.CallResult<Contract__observeResult> {
    let result = super.tryCall(
      "observe",
      "observe(uint32[]):(int56[],uint160[])",
      [ethereum.Value.fromUnsignedBigIntArray(secondsAgos)]
  ...
  positions(param0: Bytes): Contract__positionsResult {
    let result = super.call(
      "positions",
  ...
  try_positions(param0: Bytes): ethereum.CallResult<Contract__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint128,uint256,uint256,uint128,uint128)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  protocolFees(): Contract__protocolFeesResult {
    let result = super.call(
      "protocolFees",
    ...
    return new Contract__protocolFeesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_protocolFees(): ethereum.CallResult<Contract__protocolFeesResult> {
    let result = super.tryCall(
      "protocolFees",
      "protocolFees():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__protocolFeesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

  slot0(): Contract__slot0Result {
    let result = super.call(
      "slot0",
    ...
    return new Contract__slot0Result(
      result[0].toBigInt(),
      result[1].toI32(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_slot0(): ethereum.CallResult<Contract__slot0Result> {
    let result = super.tryCall(
      "slot0",
      "slot0():(uint160,int24,uint16,uint16,uint16,uint8,bool)",
      []
  ...
  snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): Contract__snapshotCumulativesInsideResult {
    let result = super.call(
      "snapshotCumulativesInside",
    ...
    return new Contract__snapshotCumulativesInsideResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_snapshotCumulativesInside(
    tickLower: i32,
    tickUpper: i32
  ): ethereum.CallResult<Contract__snapshotCumulativesInsideResult> {
    let result = super.tryCall(
      "snapshotCumulativesInside",
      "snapshotCumulativesInside(int24,int24):(int56,uint160,uint32)",
      [ethereum.Value.fromI32(tickLower), ethereum.Value.fromI32(tickUpper)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__snapshotCumulativesInsideResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  swap(
    ...
    return new Contract__swapResult(result[0].toBigInt(), result[1].toBigInt());
  }
  ...
  try_swap(
    ...
    sqrtPriceLimitX96: BigInt,
    data: Bytes
  ): ethereum.CallResult<Contract__swapResult> {
    let result = super.tryCall(
      "swap",
      "swap(address,bool,int256,uint160,bytes):(int256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__swapResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  ticks(param0: i32): Contract__ticksResult {
    let result = super.call(
      "ticks",
    ...
    return new Contract__ticksResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_ticks(param0: i32): ethereum.CallResult<Contract__ticksResult> {
    let result = super.tryCall(
      "ticks",
      "ticks(int24):(uint128,int128,uint256,uint256,int56,uint160,uint32,bool)",
      [ethereum.Value.fromI32(param0)]
